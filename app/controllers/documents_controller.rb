class DocumentsController < ApplicationController
  ...
  def new
    ...
    render design_system_view(:new, :new_legacy)
  end
  ...
  def create
    ...
    if @document.save
      ...
      re_render design_system_view(:new, :new_legacy), flash_key: :errors, flash_message: document_error_messages, status: :unprocessable_entity
    else
      re_render design_system_view(:new, :new_legacy), flash_key: :danger, flash_message: unknown_error_message
    end
  end
