FactoryBot.define do
  ...
  factory :foo_editor, parent: :editor do
  ...
  factory :foo_project, parent: :document do
    base_path { "/foo-projects/example-document" }
      ...
      default_metadata do
        {
          ...
          "foo_project_closed_date" => "2015-01-01",
          "foo_project_type" => "annual-report",
          "foo_project_state" => "closed",
        }
      end
    end
  end
