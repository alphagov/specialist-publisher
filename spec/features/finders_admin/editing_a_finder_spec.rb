...
RSpec.feature "Editing a finder", type: :feature do
  ...
  scenario "changing all fields" do
    ...
    choose("No", name: "index_documents_in_search_engines")
    ...
    expect(page.find(".govuk-summary-list__row", text: "Should the documents be indexed by search engines?")).to have_selector("dt", text: "No")
    click_button "Submit changes"
